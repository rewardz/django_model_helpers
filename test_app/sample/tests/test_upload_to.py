...
def test_upload_to():
    ...
    assert upload_to(fake_instance, "/tmp/filezx/myfile.png") == "FakeModel/%d/myfile-1.png" % year
    assert upload_to(fake_instance, "/tmp/filezx/1234567890123456.png") == "FakeModel/%d/1234567890-1.png" % year
    ...
    assert model_helpers.upload_to(fake_instance, "/tmp/filezx/myfile.png") == "FakeModel/%d/myfile-1.png" % year
